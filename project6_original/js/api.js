...
export async function getWeatherByCity(city) {
    if (!API_KEY || API_KEY === 'YOUR_OPENWEATHERMAP_API_KEY_HERE') {
        throw new Error('API key is missing. Please provide your OpenWeatherMap API key in js/api.js');
    }
    const url = `${OPENWEATHERMAP_API_BASE}?q=${encodeURIComponent(city)}&appid=${API_KEY}&units=metric`;
    try {
