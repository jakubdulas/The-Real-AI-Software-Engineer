...
class MultiAgentSystem(Agent):
    ...
    def add_agent(self, name, graph, state_schema):
...
if __name__ == "__main__":
    ...
    system.add_agent("coder", coder.graph, coder.state)
    system.add_agent(
        "researcher",
        Researcher("gpt-4o-mini").graph,
    ...
    system.invoke({"messages": "Zrob mi pacmana"})
